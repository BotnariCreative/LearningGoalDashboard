  ...
  return (
    <div className="flex min-h-dvh items-center justify-center px-4">
      <div ref={cardRef} className="relative w-full max-w-sm overflow-hidden rounded-2xl border border-white/10 bg-white/4 p-8 backdrop-blur-md">
        <GrainTexture id="login" />

        <div className="relative z-10">
          {/* Logo */}
          <div className="mb-8">
            <span className="ml-2 text-xs tracking-[0.35em] uppercase text-white/40">ADMIN</span>
          </div>
          ...
          <p className="mb-8 text-sm text-white/40">
            Access the admin dashboard to manage your learning goals.
          </p>
